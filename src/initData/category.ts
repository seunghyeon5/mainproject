  ...
  const Category: Array<ICategory> = [
    {
      title: "VODKA",
      image:
        "https://drinks-info-for-ct.s3.ap-northeast-2.amazonaws.com/category/vodka-icon.png",
      description:
    ...
    },
    {
      title: "GIN",
      image:
        "https://drinks-info-for-ct.s3.ap-northeast-2.amazonaws.com/category/gin-icon.png",
      description:
        "대표적인 증류주 한 종류 알코올 도수는 대개 40도 이상이며 독특한 향취(강한 솔향)가 있다. 주로 칵테일을 제조하는 데 많이 쓰인다.",
    },
    {
      title: "RUM",
      image:
        "https://drinks-info-for-ct.s3.ap-northeast-2.amazonaws.com/category/rum-icon.png",
      description:
    ...
    },
    {
      title: "TEQUILA",
      image:
        "https://drinks-info-for-ct.s3.ap-northeast-2.amazonaws.com/category/tequila-icon.png",
      description:
        "멕시코산 술. 대표적 증류주 중 하나로 알콜 농도는 40~52%. 할리스코 주에 위치한 Tequila라는 지역의 이름을 딴 것.",
    },
    {
      title: "LIQUEUR",
      image:
        "https://drinks-info-for-ct.s3.ap-northeast-2.amazonaws.com/category/liqueur-icon.png",
      description:
